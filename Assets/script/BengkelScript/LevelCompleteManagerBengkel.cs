...
public class LevelCompleteManagerBengkel : MonoBehaviour
{
    ...
    [SerializeField] private string levelStarKey = "BengkelStars";
    [SerializeField] private string levelTimeKey = "BengkelBestTime";
    [SerializeField] private string nextLevelUnlockKey = "RuncitUnlocked";
    ...
    private IEnumerator AnimateStarsRoutine()
    {
        ...
        if (timerManager != null)
        {
            ...
            Debug.Log("[Star System - Bengkel] Time taken: " + timeTaken + " seconds.");
